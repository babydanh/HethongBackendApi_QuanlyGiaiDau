        ...
        const generated = await this.db.transaction(async (tx) => {
          ...
          const [newTournament] = await tx
            ...
            .values({
              ...
              platformFeePercentage: lockedTemplate.platformFeePercentage,
              platformFeeThreshold: lockedTemplate.platformFeeThreshold,
              platformFeeFixedAmount: lockedTemplate.platformFeeFixedAmount,
